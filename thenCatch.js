...
// 1. The promise above is incomplete. On line 14 inside the Promise, create conditions for the promise to resolve or reject.
...
// 2. Consume the promise using then() and catch().
